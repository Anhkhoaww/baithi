      ...
      <table border="3" cellpadding="10" style="font-size: 15px;">
          ...
          <thead>
               <tr>
                  ...
                  <!-- <th class="theadd">Loại khuyến mãi</th> -->
          ...
          <tbody>
            <?php foreach ($data as $value) { ?>
              ...
              <tr>
                 ...
                 <td><?= $value['tenSP'] ?></td>
                 <!-- <td>{{$sp->sanpham->id}}.{{$km->khuyenmai->idkm}}</td> -->
                  <td><?= $value['Dongia'] ?>.000 VND</td>
                  <td>
                    <?php 
                    if($value['idLoaiSP'] == 1) echo "xe  "; 
                    if($value['idLoaiSP'] == 2) echo "xe số"; 
                    if($value['idLoaiSP'] == 3) echo "xe ga"; 
                    if($value['idLoaiSP'] == 4) echo "xe pkl"; 
                    ?>
                  </td> 
                  <td><?= $value['soluong'] ?></td>
