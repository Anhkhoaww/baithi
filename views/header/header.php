                                  ...
                                  <div class="dropdown-content22"> 
                                    <!-- <a class="aacount" href="#"><center><span>Đăng nhập</span></center></a>-->
                                     <ul>
                                        ...
                                        <li><a class="aacount" href="?action=dangxuat" onclick="TBdangxuat()"><span>Đăng xuất</span></a></li><br>
                                     ...
                                     <?php }}else{ ?>
                                        ...
                                        <li><a class="aacount" href="?action=dangnhap"><span>Login & Signup</span></a></li>
                                      <?php } ?>
                                    </ul>
                                  </div>
                            </div>
                        ...
                        <div class="mainmenuu pull-left">
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li><a href="?action=trangchu" class="active">
                                  <div class="btn-group">
                                        <img src="public/image/logooo.png" alt="logo" title="về trang chủ">
                                 </div>
                                </a></li>
                              ...
                              <?php }  ?>
                              <li class="dropdown"><a href="?action=lienhe1">Liên hệ</a></li> 
